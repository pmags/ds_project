...
Due to time restrictions the present project follows a hibryd approach of CRISP-DM and TDSF and is organized in the following stages:

Stage 1 - Undertand Business and Its environment

Stage 2 - Understand and explore data: study of distribution and relationship among available data

Stage 3 - Data preparation for modeing: Preprocessing workflow

Stage 4 - Modeling: Model definition, initial experiments and hyperparamete tunning
