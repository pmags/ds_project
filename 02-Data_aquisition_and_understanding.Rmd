...
*bought:* categorical variable flagging if a order was made during that session. If true the value is 1 and zero undewise. Category available already has dummy. **This is the target or dependent variable of this project**.
...
```{r,unbalanced data, include=FALSE}
